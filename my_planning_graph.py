...
def check_effect_mutex(eff1, eff2):
...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (check_effect_mutex(node_a1.action.effect_add, node_a2.action.effect_rem) 
               or check_effect_mutex(node_a1.action.effect_rem, node_a2.action.effect_add))
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (check_effect_mutex(node_a1.action.effect_add, node_a2.action.precond_neg) 
                or check_effect_mutex(node_a1.action.effect_rem, node_a2.action.precond_pos) 
                or check_effect_mutex(node_a2.action.effect_add, node_a1.action.precond_neg) 
                or check_effect_mutex(node_a2.action.effect_rem, node_a1.action.precond_pos))
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            gs = PgNode_s(goal, True)
            for index, level_set in enumerate(self.s_levels):
                if gs in level_set:
                    level_sum += index
                    break
        return level_sum
